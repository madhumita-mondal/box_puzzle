...
function updateIQ() {
  ...
  if (moves <= 40) iqScore += 40;
  else if (moves <= 60) iqScore += 30;
  else if (moves <= 90) iqScore += 20;
  else iqScore += 15;

  if (seconds <= 60) iqScore += 25;
  else if (seconds <= 120) iqScore += 20;
  else if (seconds <= 180) iqScore += 15;
